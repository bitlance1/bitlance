  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(firebaseAuth, async (user) => {
      ...
      try {
        ...
        const firstName = (f.firstName as string) || displayParts[0] || "";
        const lastName  = (f.lastName  as string) || (displayParts.length > 1 ? displayParts.slice(1).join(" ") : "");
        ...
        try {
          ...
          const workHistoryFromContracts = contractsSnap.docs
            ...
            .sort((a) => (a.status === "COMPLETED" ? -1 : 1)); // finished first
          ...
          <div className="px-3 sm:px-5 lg:px-8 py-6 sm:py-8">
            ...
            <div className="w-full max-w-6xl mx-auto flex flex-col gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start gap-2 flex-wrap">
                        <h1 className="text-[26px] md:w-[290px] sm:text-[34px] lg:text-[40px] font-black text-[#0f0f0f] leading-[1.1] tracking-tight">
                          {fullName}
                        </h1>
                        {profile.verified && (
              ...
              {/* ────────────────────────────────────────────────────────
                  ...
                  inner div: [DIV-1 (bio + skills)] + [DIV-2 (ledger chart)]
              ──────────────────────────────────────────────────────── */}
              <div className="flex flex-col lg:flex-row gap-5">
              ...
              {/* ────────────────────────────────────────────────────────
                  ...
                  Full-width — label + "Showing X of Y" + cards
              ──────────────────────────────────────────────────────── */}
              <div className="lg:w-[70%] ">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {/* Firebase: replace hardcoded numbers with workHistory.length and jobsCompleted */}
                  <p className="text-[11px] sm:text-[12px] text-[#999]">
                    Showing latest {profile.workHistory.length} of {profile.jobsCompleted}
                  </p>
                </div>

                {/* Work history cards — Firebase: map over workHistory array */}
              ...
              {/* ────────────────────────────────────────────────────────
                  PORTFOLIO SECTION
                  Full-width — label + 2-column image grid
              ──────────────────────────────────────────────────────── */}
              <div className="lg:w-[70%]  pb-8">
                ...
                {/* Image grid — Firebase: map over portfolioItems array */}
